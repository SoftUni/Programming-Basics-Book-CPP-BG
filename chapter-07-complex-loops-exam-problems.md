...
Решете задачата самостоятелно, използвайки наученото от предходните. Спомнете си разликата между операторите за **целочислено деление (__/__)** и **деление с остатък (__%__)** в C++.
