...
В езика за програмиране **C++** се забелязва разлика в понятията **деклариране** и **дефиниция** на функции.
...
Най-добре познатият ни пример за функция е функцията **`main(…)`**, който използваме във всяка една програма, която пишем.

Със следващия пример ще разгледаме
