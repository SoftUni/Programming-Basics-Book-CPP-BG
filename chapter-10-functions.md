...
На прост език казано, ако декларираме една  структура, то това означава, че тя е съвкупност от други променливи, разбира се, които също се декларират. Ето един пример за структура:
