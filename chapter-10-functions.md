...
Това са данните (променливи или дори константи), които се предават на функцията, да да ги обработи, връщайки стойност или изпълнявайки някаво действие. Трябва да се внимава за параметрите да бъдат подредени по един и същ начин при декларирането и дефинирането на функцията.
