...
След като сме декларирали функцията, следва нейната **дефиниция**. Дефиницията на функция представлява **описването** на **нейното тяло (имплементацията)**, което съдържа кода (програмен блок), реализиращ **логиката** на функцията. В показания пример изчисляваме лицето на квадрат, а именно **`num * num`**. Това е дефиницията на по-горе декларираната функция **`getSquare`**.
