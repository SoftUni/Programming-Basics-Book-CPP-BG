...
**Функцията обаче има още една част, а за раликите между двете, употребата и значението им ще коментираме подробно в главата.**
...
<img src = "/assets/chapter-10-images/02_example_function_03.PNG"/>
