...
<table><tr><td><img src="/assets/alert-icon.png" style="max-width:30px" /></td>
...
<td>Оттук нататък в темата ще бъдат показвани само примери за дефиниции на функции. Изграждането на техните прототипи остава за читателя. (вж. подтема **Деклариране**)</td>
</tr></table>
