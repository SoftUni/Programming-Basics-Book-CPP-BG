...
Следващият ред е **еквивалентен** на горния, но защо е така и има ли някакво влияние, ще разберем по-долу.
...
**Декларирането** на една функция се осъществява **след `using namespace std;`** и **преди главната функция `main()`**.
