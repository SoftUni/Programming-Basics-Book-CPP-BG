...
```
Низовете, в които има интервали, се сравняват лексикографски, както познатите ни дотук стрингове. Въвеждането на стринг по този начен е полезно умение, даващо по-голяма свобода при работа с низове, както и практичност.
#### Тестване в Judge системата
