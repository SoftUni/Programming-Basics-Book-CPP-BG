...
Задачата може да се реши, като се използва функцията **`pow`** от библиотеката **`cmath`**. След като сме направили нужните изчисления, ни остава да разпечатаме резултата в главната функция **`main()`** на програмата.
