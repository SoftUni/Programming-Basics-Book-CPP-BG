...
**Внимание!!! Това не е цяла програма, а три фрагмента от нея, а как ще подредим всичко това, ще разгледаме в следващата подтема.**
...
**Важно:** Разгледаното тук извикване на функции не е разгледано за функции, връщащи стойности. За тях ще разберем малко по-нататък при **Връщане на резултат от функция/**.
