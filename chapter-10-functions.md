...
**Внимание!!! Това не е цяла програма, а три фрагмента от нея. Начинът, по който подреждаме всичко това, ще разгледаме в следващата подтема.**
...
```
Можете да тествате примера онлайн: https://repl.it/@Denis77/AppropriateGloomyFilesize .
...
Факт е, че вторият подход изисква по-малко писане на код, но в **практиката** често се използва **първия подход**, тъй като дава по-добра **четимост** на програмата, а и при по-сложни програми **улеснява** програмиста. **В настоящата книга се използва метода с отделените декларация и дефиниция.**
