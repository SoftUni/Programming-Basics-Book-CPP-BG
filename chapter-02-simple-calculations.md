...
```
В този пример е използван друг начин за вход, тъй като не се знае колко думи ще бъдат въведени за име. Поради тази причина, в С++ съществува функция **getline**, с чиято помощ се извличат всички символи, написани на един ред (включително и интeрвалите). В десета глава, функциите ще бъдат подробно обяснени, но нека разгледаме какво трябва да запишем в дадената.
