...
При въвеждане и извеждане на текст, библиотеката **`<string>`** е нужно да бъде включена. За прочитане на текст от системната конзола си **декларираме нова променлива** (от тип стринг) и използваме **`>>`** (оператор за побитово изместване надясно):
