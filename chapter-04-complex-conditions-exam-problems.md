...
<td>Запомнете, че не е добра практика писането на <strong>дълбоко вложени условни конструкции</strong> (с ниво на влагане повече от три). Избягвайте влагане на повече от три условни конструкции една в друга. Това усложнява кода и затруднява неговото четене и разбиране.</td>
</tr></table>
...
Тествайте решението си тук:  [https://judge.softuni.org/Contests/Practice/Index/1363#0](https://judge.softuni.org/Contests/Practice/Index/1363#0).
...
<table><tr><td><img src="/assets/alert-icon.png" style="max-width:50px" /></td>
<td>Винаги преценявайте какъв <strong>тип стойност</strong> се подава при входните данни, за да работят правилно създадените от вас програмни конструкции!</td>
</tr></table> 
...
Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1363#1](https://judge.softuni.org/Contests/Practice/Index/1363#1).
...
Задачата не е сложна, но има доста редове код за писане. Както вече разбрахме, е **добра практика** да **разделяме кода си на части**, но при тази задача това само би я **усложнило**.
...
Прочитайки внимателно условието, разбираме, че има случаи, в които не трябва да правим **никакви** изчисления, а просто да изведем резултат. Следователно първо може да проверим дали второто число е **`0`** (нула), както и дали операцията е **деление** или **модулно деление**, след което да принтираме необходимото съобщение:
...
Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1363#2](https://judge.softuni.org/Contests/Practice/Index/1363#2).
...
Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1363#3](https://judge.softuni.org/Contests/Practice/Index/1363#3).
...
Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1363#4](https://judge.softuni.org/Contests/Practice/Index/1363#4).
