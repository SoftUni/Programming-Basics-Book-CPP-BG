...
Относно кода по-горе трябва да поясним два детайла. Първият е използването на тип **`double`** за **съхранение на резултата на нашето уравнение**. Вторият е стойността по подразбиране на оператора - тя е **`+`**, за да може още първото срещнато число да бъде събрано с резултата ни.
