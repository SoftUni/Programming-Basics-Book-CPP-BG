...
|----|----|----|----|
|5<br>-2<br>6<br>1<br>1<br>1|7.5|<img src = "/assets/old-images/old-imagesassets/chapter-8-1-images/01.Triangle-area-01.png"/>|Страната на триъгълника **а** = 6 - 1 = **5**<br>Височината на триъгълника **h** = 1 - (-2) = **3**<br>Лицето на триъгълника **S** = a \* h / 2 = 5 \* 3 / 2 = **7.5**|

|Вход|Изход|Чертеж|Обяснения|
|----|----|----|----|
|4<br>1<br>-1<br>-3<br>3<br>-3|8|<img src = "/assets/old-images/old-imagesassets/chapter-8-1-images/01.Triangle-area-02.png"/>|Страната на триъгълника **а** = 3 - (-1) = **4**<br>Височината на триъгълника **h** = 1 - (-3) = **4**<br>Лицето на триъгълника **S** = a \* h / 2 = 4 \* 4 / 2 = **8**|
