...
Достатъчно условие е **точката** да се намира в един от тях, за да бъде във **фигурата**.
...
Въвеждаме данните от конзолата.

<img src = "/assets/chapter-8-1-images/05.Date-after-5-days-01.png"/>
...
<img src = "/assets/chapter-8-1-images/05.Date-after-5-days-02.png"/>

Увеличаваме **деня** с 5: **`d += 5;`**

Проверяваме дали **денят** не е станал по-голям от броя дни, които има в съответния **месец**. Ако това е така, трябва да извадим дните от месеца от получения ден, за да разберем на кой ден от следващия месец съответства.

<img src = "/assets/chapter-8-1-images/05.Date-after-5-days-03.png"/>
...
<img src = "/assets/chapter-8-1-images/05.Date-after-5-days-05.png"/>

Остава само да изведем резултата на конзолата. Важно е да съобразим, че трябва да има **водеща нула** в първите 9 месеца и да добавим следното **условие**:

<img src = "/assets/chapter-8-1-images/05.Date-after-5-days-04.png"/>
...
Въвеждаме необходимите данни от клавиатурата.

<img src = "/assets/chapter-8-1-images/06.Sums-3-numbers-01.png"/>
...
Ще си напишем **рамка**, която после ще допълним с нужния код. Ако никое от горните три условия не е изпълнено, ще зададем на програмата да извежда "**No**".

<img src = "/assets/chapter-8-1-images/06.Sums-3-numbers-02.png"/>
...
<img src = "/assets/chapter-8-1-images/06.Sums-3-numbers-03.png"/>

Аналогично, ще допълним и другите два случая. Пълният код на проверките и изходът на програмата ще изглеждат така:

<img src = "/assets/chapter-8-1-images/06.Sums-3-numbers-04.png"/>
...
<img src = "/assets/chapter-8-1-images/07.Sums-Step-3-01.PNG"/>
...
<img src = "/assets/chapter-8-1-images/07.Sums-Step-3-02.PNG"/>

За да разберем в коя от **трите суми** трябва да добавим числото, ще резгледаме **остатъка** на **поредния му номер на три**. Ще използваме променливата **`i`**, която следи **броя завъртания** на цикъла, за да разберем на кое поред число сме. Когато остатъкът от **`i/3`** е **нула**, това означава, че ще добавяме това число към **първата** сума, когато е **1** към **втората** и когато е **2** към **третата**.

<img src = "/assets/chapter-8-1-images/07.Sums-Step-3-03.PNG"/>

Накрая, ще отпечатаме резултата на конзолата в изисквания **формат**.

<img src = "/assets/chapter-8-1-images/07.Sums-Step-3-04.PNG"/>
...
За решението на тази задача трябва да помислим малко **по-алгоритмично**. Дадена ни е **редица от числа** и трябва да проверяваме дали всяко **следващо**, ще бъде **по-голямо от предното** и ако е така да броим колко дълга е редицата, в която това условие е изпълнено. След това трябва да намерим **коя редица** от всички такива е **най-дълга**. За целта, нека да си създадем няколко променливи, които ще ползваме през хода на задачата. <br>
...
<img src = "/assets/chapter-8-1-images/08.Increasing-numbers-01.PNG"/>
...
<img src = "/assets/chapter-8-1-images/08.Increasing-numbers-02.PNG"/>
...
<img src = "/assets/chapter-8-1-images/08.Increasing-numbers-03.PNG"/>

Накрая извеждаме дължината на **най-дългата** намерена редица.

<img src = "/assets/chapter-8-1-images/08.Increasing-numbers-04.PNG"/>
...
<img src = "/assets/chapter-8-1-images/09.Perfect-diamond-03.PNG"/>
...
<img src = "/assets/chapter-8-1-images/09.Perfect-diamond-04.PNG"/>

Остава **да си сглобим цялата програма** като първо четем входа, после извеждаме горната част и след това и долната част на диаманта.
...
<img src = "/assets/chapter-8-1-images/10.Rectangle-with-stars-01.PNG"/>
...
<img src = "/assets/chapter-8-1-images/10.Rectangle-with-stars-02.PNG"/>
...
<img src = "/assets/chapter-8-1-images/10.Rectangle-with-stars-03.PNG"/>
...
<img src = "/assets/chapter-8-1-images/10.Rectangle-with-stars-04.PNG"/>
...
<img src = "/assets/chapter-8-1-images/11.Increasing-4-numbers-01.PNG"/>
...
<img src = "/assets/chapter-8-1-images/11.Increasing-4-numbers-02.PNG"/>
...
<img src = "/assets/chapter-8-1-images/11.Increasing-4-numbers-03.PNG"/>

Накрая ще проверим дали **броячът** е равен на **0** и съответно ще принтираме “**No**” на конзолата, ако е така.

<img src = "/assets/chapter-8-1-images/11.Increasing-4-numbers-04.PNG"/>
...
<img src = "/assets/chapter-8-1-images/12.Generating-rectangles-01.PNG"/>
...
<img src = "/assets/chapter-8-1-images/12.Generating-rectangles-02.PNG"/>
...
<img src = "/assets/chapter-8-1-images/12.Generating-rectangles-03.PNG"/>

Накрая принтираме “**No**”, ако не съществуват такива правоъгълници.

<img src = "/assets/chapter-8-1-images/12.Generating-rectangles-04.PNG"/>
