...
По същия начин, както четем цяло число, но този път ще използваме променлива от тип **`double`**:
...
**Placeholder** представлява израз, който ще бъде заменен с конкретна стойност при отпечатване. Функцията **`printf`**  поддържа печатане на текст по шаблон, като първият аргумент, който трябва да подадем, е форматиращият низ, следван от броя аргументи, равен на броя на плейсхолдърите.

```c++
printf("You are %s %s, a %d-years old person from %s", firstName.c_str(), secondName.c_str(), age, town.c_str());
```
...
int age = 19;
string str = firstName + " " + lastName + " is " + to_string(age) + " years old";
// Ivan Ivanov is 19 years old
```
**to_string()** конвертира годините в текст, за да може да се извърши конкатенацията
...
Първото, което трябва да направим, е да прочетем входните данни от конзолата. Със **`cin`** четем стойностите от конзолата, а типът данни ще бъде double

![](/assets/chapter-2-2-images/01.Training-Lab-01.png)
...
Тествайте решението си тук: [https://judge.softuni.bg/Contests/Practice/Index/1359#0](https://judge.softuni.bg/Contests/Practice/Index/1359#0).
...
Тествайте решението си тук: [https://judge.softuni.bg/Contests/Practice/Index/1359#2](https://judge.softuni.bg/Contests/Practice/Index/1359#2).
...
Тествайте решението си тук: [https://judge.softuni.bg/Contests/Practice/Index/1359#3](https://judge.softuni.bg/Contests/Practice/Index/1359#3).
...
Тествайте решението си тук: [https://judge.softuni.bg/Contests/Practice/Index/1359#4](https://judge.softuni.bg/Contests/Practice/Index/1359#4).
