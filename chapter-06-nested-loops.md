...
Как работи примерът? Създава се **променлива от тип `string`** Инициализира се **цикъл с променлива `i = 0`**, която се увеличава на всяка итерация на цикъла, докато е **по-малка от 10**. Така кодът в тялото на цикъла се изпълнява **10 пъти**. В тялото на цикъла се добавя по една звездичка към низа. Това означава, че **след края** на цикъла низа ще съдържа **10 звездички**. Инициализира се **втори цикъл**, който **също** се изпълннява **10 пъти**. В тялото на втория цикъл се печата на нов ред в конзолата **низа от 10 звездички**, създаден преди това.
