...
Редът **`using namespace std;`** означава използвай namespace **`std`**. Какво е namespace? Представете си, че по даден проект работят много хора, сред които Пешо и Гошо. Пешо иска да си кръсти някоя променлива **broi**, но и Гошо иска да използва променлива с име **broi**. За компилатора тези две променливи ще означават едно и също, независимо дали Пешо или Гошо я използва. За да се реши този проблем, се използва **namespace**. Тогава Пешо ще си има namespace Pesho, а Гошо ще си има namespace Gosho. За да използва Пешо своята променлива **broi**, ще напише **Pesho::broi**, а Гошо, за да използва своята променлива **broi**, ще напише съответно **Gosho::broi**. Тогава вече компилаторът ще прави разлика между променливата **broi** на Гошо и съответно на Пешо. Символите **::** означават да се вземе променливата, написана отдясно на **::**, от namespace-а, написан отляво на **::**. 
