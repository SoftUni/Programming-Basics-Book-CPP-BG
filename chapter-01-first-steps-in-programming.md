...
Редът **#include <iostream>** означава използвай кода от библиотеката **iostream**. **include** буквално означава включи този код в моя. Библиотеките са код, койото можем да използваме на готово. Например от библиотеката **iostream** използваме **cin** и **cout**. Има най-различни други библиотеки, също така сами можем да си пишем библиотеки, но няма да се занимаваме с това сега.

Редът **using namespace std;** означава използвай namespace-a **std**. Какво е namespace? Представете си, че по даден проект работят много хора, сред които Пешо и Гошо. Пешо иска да си кръсти някоя променлива **broi**, но и Гошо иска да използва променлива с име **broi**. За компилатора тези две променливи ще означават едно и също, независимо дали Пешо или Гошо я използва. За да се реши този проблем, се използва namespace-a. Тогава Пешо ще си има namespace Pesho, а Гошо ще си има namespace Gosho. За да използва Пешо своята променлива **broi**, ще напише **Pesho::broi**, а Гошо, за да използва своята променлива **broi**, ще напише съответно **Gosho::broi**. Тогава вече компилаторът ще прави разлика между променливата **broi** на Гошо и съответно на Пешо. Символите **::** означават да се вземе променливата, написана от дясно на **::**, от namespace-а, написан от ляво на **::**. 
