...
Можем да решим задачата за най-голямо число по следния начин:
 ...
 - Създаваме цикъл започващ от 1 (за да прескочим първото число, което взехме ръчно) до **`n`**.
