...
Да се напише програма, която въвежда **2 \* n цели числа** и проверява дали **сборът на първите n числа** (ляв сбор) е равен на **сбора на вторите n числа** (десен сбор). При равенство се печата **"Yes" + сбора**, иначе се печата **"No" + разликата**. Разликата се изчислява, като положително число (по абсолютна стойност). Форматът на изхода трябва да е като в примерите по-долу.
...
Да се напише програма, която въвежда **n цели числа** и проверява дали **сборът на числата на четни позиции** е равен на **сбора на числата на нечетни позиции**. При равенство печата **"Yes" + сбора**, в противен случай печата **"No" + разликата**. Разликата се изчислява по абсолютна стойност. Форматът на изхода трябва да е като в примерите по-долу.
